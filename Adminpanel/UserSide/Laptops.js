    ...
    function filterProducts() {
        ...
        products.forEach(product => {
            ...
            switch (selectedFilter) {
                case 'below-50000':
                    product.style.display = productPrice < 50000 ? 'block' : 'none';
                    break;
                case '50000-80000':
                    product.style.display = (productPrice >= 50000 && productPrice <= 80000) ? 'block' : 'none';
                    break;
                case '80000-150000':
                    product.style.display = (productPrice >= 80000 && productPrice <= 150000) ? 'block' : 'none';
                    break;
                case '150000-200000':
                    product.style.display = (productPrice >= 150000 && productPrice <= 200000) ? 'block' : 'none';
                    break;
                case '200000-above':
                    product.style.display = productPrice > 200000 ? 'block' : 'none';
                    break;
                default:
