...
<head>
    ...
    <title>Samangri Nepal - Watches</title>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <!-- Search Bar -->
            <div class="search">
                <input type="text" id="search" placeholder="Search watches...">
            ...
            <div class="product-list">
                ...
                $sql = "SELECT name, price, description, image FROM products WHERE category = 'Watches'";
