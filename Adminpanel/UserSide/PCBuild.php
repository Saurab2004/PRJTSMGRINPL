...
<head>
    ...
    <title>Samangri Nepal - PC Build</title>
    <link rel="stylesheet" href="./CSS/mobile.css">
    <script defer src="PCBUILD.js"></script>
</head>
<body>
    <div class="container">
        <div class="sidebar">
        ...
        <div class="content">
            ...
            <!-- Search Bar -->
            <div class="search">
                <input type="text" id="search" placeholder="Search PC Builds...">
            ...
            <div class="filters">
                ...
                <div class="filter-price">
                    ...
                    <label><input type="radio" name="price" value="50000-100000"> RS:50000-RS:100000</label>
                    <label><input type="radio" name="price" value="100000-150000"> RS:100000-RS:150000</label>
                    <label><input type="radio" name="price" value="150000-200000"> RS:150000-RS:200000</label>
                    <label><input type="radio" name="price" value="200000-300000"> RS:200000-RS:300000</label>
                    <label><input type="radio" name="price" value="300000-above"> RS:300000-Above</label>
                </div>
                <div class="sort-by">
            ...
            <div class="product-list">
                ...
                $sql = "SELECT name, price, description, image FROM products WHERE category = 'PC Build'";
